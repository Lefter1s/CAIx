...
contains(RELEASE, 1) {
        ...
        macx:QMAKE_LFLAGS += -mmacosx-version-min=10.7 -arch x86_64 -isysroot /Developer/SDKs/MacOSX10.7.sdk
...
QMAKE_CXXFLAGS *= -fstack-protector-all --param ssp-buffer-size=1 -g
...
contains(USE_QRCODE, 1) {
        ...
        win32:LIBS += $$join(QRENCODE_LIB_PATH,,-L)
        LIBS += -lqrencode
}
...
OTHER_FILES += \
        doc/*.rst doc/*.txt doc/README README.md res/caix-qt.rc
...
macx:ICON = src/qt/res/icons/caix.icns
macx:TARGET = "CAIx-Qt"
