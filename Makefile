#############################################################################
# Makefile for building: CAIx-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: niedz. cze 1 23:51:19 2014
# Project:  caix-qt.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile caix-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DBOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN -D__NO_SYSTEM_INCLUDES -DUSE_QRCODE -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lqrencode /home/oisis/work/CCoins/caix-1.1/src/leveldb/libleveldb.a /home/oisis/work/CCoins/caix-1.1/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
/home/oisis/work/CCoins/caix-1.1/src/leveldb/libleveldb.a: FORCE
	cd /home/oisis/work/CCoins/caix-1.1/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/oisis/work/CCoins/caix-1.1/build/build.h: FORCE
	cd /home/oisis/work/CCoins/caix-1.1; /bin/sh share/genbuild.sh /home/oisis/work/CCoins/caix-1.1/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/images/caix-splash.png \
		src/qt/res/movies/update_spinner.mng \
		src/qt/res/movies/caix.gif \
		...
		src/qt/res/icons/CAIx-16.png \
		src/qt/res/icons/statistics.png \
		src/qt/res/icons/CAIx-128.png \
